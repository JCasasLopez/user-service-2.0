...
CREATE TABLE IF NOT EXISTS login_attempts (
    ...
    loginFailureReason ENUM('INCORRECT_PASSWORD','USER_NOT_FOUND','MISSING_FIELD','ACCOUNT_LOCKED','OTHER') DEFAULT NULL, -- << CORREGIDO: ENUM
    idUser INT DEFAULT NULL,
    PRIMARY KEY (idLoginAttempt),
    KEY idUser_idx (idUser), 
    CONSTRAINT idUser FOREIGN KEY (idUser) REFERENCES users(idUser) ON DELETE SET NULL 
);